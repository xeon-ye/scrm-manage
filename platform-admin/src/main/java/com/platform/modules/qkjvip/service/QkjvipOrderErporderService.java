/*
 * 项目名称:platform-plus
 * 类名称:QkjvipOrderErporderService.java
 ...
 */
public interface QkjvipOrderErporderService extends IService<QkjvipOrderErporderEntity> {
     ...
     * 新增
     *
     * @param qkjvipOrderErporder 
     * @return 新增结果
     */
    boolean add(QkjvipOrderErporderEntity qkjvipOrderErporder);
     ...
     * @return 更新结果
     */
    boolean update(QkjvipOrderErporderEntity qkjvipOrderErporder);
