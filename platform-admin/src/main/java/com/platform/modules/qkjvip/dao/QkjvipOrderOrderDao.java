 ...
 */
@Mapper
public interface QkjvipOrderOrderDao extends BaseMapper<QkjvipOrderOrderEntity> {
     ...
     * @return List
     */
    List<QkjvipOrderOrderEntity> queryAll(@Param("params") Map<String, Object> params);
