/*
 * 项目名称:platform-plus
 * 类名称:QkjvipOrderOrderService.java
 ...
 */
public interface QkjvipOrderOrderService extends IService<QkjvipOrderOrderEntity> {
     ...
     * 新增
     *
     * @param qkjvipOrderOrder 
     * @return 新增结果
     */
    boolean add(QkjvipOrderOrderEntity qkjvipOrderOrder);
     ...
     * @return 更新结果
     */
    boolean update(QkjvipOrderOrderEntity qkjvipOrderOrder);
