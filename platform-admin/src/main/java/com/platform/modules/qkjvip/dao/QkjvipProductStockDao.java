/*
 * 项目名称:platform-plus
 * 类名称:QkjvipProductStockDao.java
 ...
 */
@Mapper
public interface QkjvipProductStockDao extends BaseMapper<QkjvipProductStockEntity> {
     ...
     * @return List
     */
    List<QkjvipProductStockEntity> queryAll(@Param("params") Map<String, Object> params);
