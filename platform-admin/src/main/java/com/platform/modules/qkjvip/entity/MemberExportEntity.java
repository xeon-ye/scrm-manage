...
public class MemberExportEntity implements Serializable {
     ...
     * 主责业务员
     */
    @Excel(name = "主责业务员", orderNum = "3", width = 15, groupName = "必填信息", fixedIndex = 3)
     ...
     * 会员性别
     */
    @Excel(name = "性别", orderNum = "6", width = 15,replace={"男_1","女_2","未知_3"}, groupName = "扩展信息", fixedIndex = 6)
    private Integer sex;
    /*
     * 是否潜在客户(0否1是)
     */
     ...
     * 生日
     */
    @Excel(name = "生日", exportFormat = "yyyy-MM-dd HH:mm:ss", orderNum = "11", width = 15, groupName = "扩展信息", fixedIndex = 11)
     ...
     * 加入时间/注册时间
     */
    @Excel(name = "注册时间", exportFormat = "yyyy-MM-dd HH:mm:ss", orderNum = "13", width = 15, groupName = "扩展信息", fixedIndex = 13)
     ...
     * 标签-圈层
     */
    @Excel(name = "圈层", orderNum = "24", width = 15, groupName = "会员标签", fixedIndex = 24)
    private String tag3;
    /*
     * 标签-消费者群体
     */
    @Excel(name = "消费者群体", orderNum = "25", width = 15, groupName = "会员标签", fixedIndex = 25)
    private String tag4;
}
