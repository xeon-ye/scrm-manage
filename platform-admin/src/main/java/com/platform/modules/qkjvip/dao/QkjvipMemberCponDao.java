 ...
 */
@Mapper
public interface QkjvipMemberCponDao extends BaseMapper<QkjvipMemberCponEntity> {
     ...
     * @return List
     */
    List<QkjvipMemberCponEntity> selectQkjvipMemberCponPage(IPage page, @Param("params") Map<String, Object> params);
}
