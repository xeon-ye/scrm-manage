/*
 * 项目名称:platform-plus
 * 类名称:QkjvipOrderOrderdetailDao.java
 ...
 */
@Mapper
public interface QkjvipOrderOrderdetailDao extends BaseMapper<QkjvipOrderOrderdetailEntity> {
     ...
     * @return List
     */
    List<QkjvipOrderOrderdetailEntity> queryAll(@Param("params") Map<String, Object> params);
