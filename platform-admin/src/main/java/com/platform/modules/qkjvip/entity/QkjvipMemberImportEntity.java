...
public class QkjvipMemberImportEntity implements Serializable {
     ...
     */
    @TableField(exist = false)
    @Excel(name = "会员圈层", orderNum = "3", width = 15, groupName = "扩展信息", fixedIndex = 3)
    private String memberlayername;
    /*
     * 标签-消费者群体
     */
    @TableField(exist = false)
    @Excel(name = "会员身份", orderNum = "4", width = 15, groupName = "扩展信息", fixedIndex = 4)
     ...
     * 性别(0男1女）
     */
    @Excel(name = "性别", orderNum = "7", width = 15, groupName = "扩展信息", fixedIndex = 7, replace={"男_1","女_2","未知_3"})
    private Integer sex;
    /**
     * 是否潜在客户(0否1是)
     */
     ...
     * 不可修改类型，否则导入的时间为null
     */
    @Excel(name = "生日", importFormat = "yyyy-MM-dd HH:mm:ss", orderNum = "12", width = 15, groupName = "扩展信息", fixedIndex = 12)
     ...
     * 不可修改类型，否则导入的时间为null
     */
    @Excel(name = "注册时间", importFormat = "yyyy-MM-dd HH:mm:ss", orderNum = "14", width = 15, groupName = "扩展信息", fixedIndex = 14)
    @JsonFormat(pattern="yyyy-MM-dd HH:mm:ss")
