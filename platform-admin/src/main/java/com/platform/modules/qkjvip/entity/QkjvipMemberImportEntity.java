...
public class QkjvipMemberImportEntity implements Serializable {
     ...
     * 推荐人
     */
    @Excel(name = "推荐人", orderNum = "8", width = 15, groupName = "扩展信息", fixedIndex = 8)
    private String referrer;
    /**
     * 年龄区间
     */
    @Excel(name = "年龄", orderNum = "9", width = 15, groupName = "扩展信息", fixedIndex = 9)
    private Integer age;
    /**
     * 生日
     * 不可修改类型，否则导入的时间为null
     */
    @Excel(name = "生日", importFormat = "yyyy-MM-dd HH:mm:ss", orderNum = "10", width = 15, groupName = "扩展信息", fixedIndex = 10)
    @JsonFormat(pattern="yyyy-MM-dd HH:mm:ss")
    private String birthday;
    /**
     * 会员邮件
     */
    @Excel(name = "邮件", orderNum = "11", width = 15, groupName = "扩展信息", fixedIndex = 11)
    private String email;
    /**
     * 加入时间/注册时间
     * 不可修改类型，否则导入的时间为null
     */
    @Excel(name = "注册时间", importFormat = "yyyy-MM-dd HH:mm:ss", orderNum = "12", width = 15, groupName = "扩展信息", fixedIndex = 12)
    @JsonFormat(pattern="yyyy-MM-dd HH:mm:ss")
     ...
     * 会员来源
     */
    @Excel(name = "会员来源", orderNum = "15", width = 15, groupName = "扩展信息", fixedIndex = 15, replace={"OMS门店_0","线下活动_1","线上活动_2","线上交易_3","线下交易_4","会员推荐_5","旅游景区_6","其他来源_20"})
